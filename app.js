...
const homeStartingContent = "More than 2 billion people over 180 countries use Daily Journal to stay in touch with friends and family, anytime and anywhere, see what people are talking about and what they have been doing in their daily lives. Daily Journal brings you closer to people and things you love to do. Daily Journal is a free for everyone. ";
const aboutContent = "Daily Journal was founded by Neil Lacsamana and Janelle Iglesias in 2020. Daily Journal continues to work fast and reliably anywhere in the world. We put people first, and value craft and simplicity in our work. Our team inspire creativity around the world by sharing their daily lives to everyone and helping over billions of people to share and to be inspired.";
const contactContent = "For all questions related to Daily Journal, contact us with our email address DJoural@gmail.com";
...
app.post("/update", function(req, res){
  ...
  Post.updateOne({_id: titleID},{title: titleUpdated},{content:contentUpdated},function(err){
    if (err) {
      console.log(err);
    } else {
